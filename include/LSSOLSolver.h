...
/*! \brief LSSOLSolver solver for both dense matrix. */
...
private:
    Eigen::LSSOL_QP solver_; /*!< QP solver */
    Eigen::MatrixXd Q_; /*!< Cost matrix */
    Eigen::MatrixXd A_; /*!< Constraint matrix */
    Eigen::VectorXd bl_; /*!< Lower constraint vector */
    Eigen::VectorXd bu_; /*!< Upper constraint vector */
};
