...
public:
     ...
     * Create a constraint of type \f$\underline{x}\leq x\leq\overline{x}\f$ or \f$\underline{X}\leq X\leq\overline{X}\f$ with \f$X=[x_1^T ... x_{nrStep}^T]^T\f$
...
public:
    /**
     * Constructor of the trajectory Bound constraint.
     * Create a constraint of type \f$\underline{u}\leq u\leq\overline{u}\f$ or \f$\underline{U}\leq U\leq\overline{U}\f$ with \f$U=[u_1^T ... u_{nrStep}^T]^T\f$
     * As \f$U\f$ is the optimization variable,
